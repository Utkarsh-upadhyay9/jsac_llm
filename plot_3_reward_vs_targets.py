...
Individual plotting script for Figure 3 from the JSAC research suite
"""
...
print("=== JSAC Figure 3: Reward vs Number of Sensing Targets ===")
...
print("Figure 3 saved as 'plots/figure_3_reward_vs_targets.png'!")
