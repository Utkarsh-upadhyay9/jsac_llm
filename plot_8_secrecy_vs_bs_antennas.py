...
Individual plotting script for Figure 8 from the JSAC research suite
"""
...
print("=== JSAC Figure 8: Secrecy Rate vs BS Antennas ===")
...
print("Figure 8 saved as 'plots/figure_8_secrecy_vs_bs_antennas.png'!")
