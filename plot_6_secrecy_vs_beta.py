...
Individual plotting script for Figure 6 from the JSAC research suite
"""
...
print("=== JSAC Figure 6: Secrecy Rate vs Beta Factor ===")
...
print("Figure 6 saved as 'plots/figure_6_secrecy_vs_beta.png'!")
