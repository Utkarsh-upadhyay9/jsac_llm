...
Individual plotting script for Figure 5 from the JSAC research suite
"""
...
print("=== JSAC Figure 5: Secrecy Rate vs Total Power ===")
...
print("Figure 5 saved as 'plots/figure_5_secrecy_vs_power.png'!")
